...
The generic openBIS ELN-LIMS only has one predefined Object type for the Inventory, _General Protocol_. Additional Object types and Collections must be created by the users, based on their needs.
